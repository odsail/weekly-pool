#!/usr/bin/env python3
"""
Test the current-season focused model on Week 1 data
"""
...
def test_current_season_model_on_week1():
    """Test current-season model on Week 1 data"""
    
    print("🧪 Testing Current-Season Model on Week 1 Data")
    print("=" * 50)
    ...
    print(f"   Improved ML Model: 56.2% accuracy (9/16 correct)")
    print(f"   Current-Season Model: {accuracy:.1%} accuracy ({sum(p['is_correct'] for p in scored_predictions)}/{len(scored_predictions)} correct)")
    
    if accuracy > 0.812:
        print(f"   🚀 Current-season model beats original picks!")
    elif accuracy > 0.625:
        print(f"   ✅ Current-season model beats original ML model!")
    elif accuracy > 0.562:
        print(f"   ✅ Current-season model beats improved ML model!")
    else:
...
def main():
    ...
    predictions, accuracy = test_current_season_model_on_week1()
    
    print(f"\n✅ Testing complete!")
    print(f"💡 The current-season model is ready for Week 2 picks!")
